#include "header.h"
					...
					//////////////////////////////////// SI JE FAIS QUE REMPLACER T1 PAR P1 CA MARCHE????????????
...
int infstrictavl_p1(avl* a, avl* b, int idx)	// faire la mm en tab et en abr	AAAAAAAAAAAAAAAAAAAAAAAAAOUOUGOUOuUUOOUOUiUoUHUPHhupHUpjlhvTIYfoYIvvtyFoluTCtYlhJhdrixipmvRXRTRIFULO
